...
public class Stormtrooper extends Character {
    ...
    public Stormtrooper(String name, String type, Location location) {
    ...
    public void createShortestPath(pathTree tempRoot,int tempX,int tempY){
        ...
        //geçici lokasyon, goodChar'ın lokasyonuna eşit olmadığı sürece
            ...
            if(!shortPath.isEmpty() && shortPath.size()>tempRoot.path.size()){
                //İyi karaktere ulaşan bir yol bulunduysa ve hesaplanacak yeni yol eski yolun uzunluğundan büyük olmayacaksa
                move(tempRoot,tempX,tempY);
                
            }else if(shortPath.isEmpty()){
                //Daha önce iyi karaktere ulaşan bir yol bulunmadıysa
                move(tempRoot,tempX,tempY);
